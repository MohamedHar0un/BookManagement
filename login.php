            ...
            <div class="col-md-12">
              ...
              <form class="form" method="POST" action="">
                ...
                <div class="form-group">
                  <input class="form-control" name="username" placeholder="Enter your Username" id="exampleInputEmail2">
                </div> <!-- /.form-group -->

                <!-- Input 2 -->
                <div class="form-group">
                  <input class="form-control" name="password" placeholder="Enter your password" id="exampleInputPassword1" type="password">
                </div> <!-- /.form-group -->
