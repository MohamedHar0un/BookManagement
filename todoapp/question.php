...
if (isset($_POST['upvote'])) {
    $upquery = mysqli_query($connect,"UPDATE voting_count SET vote_up=vote_up+1 WHERE `question_id` ='$question'");
    header("location: question.php?question=".$question);
}
if (isset($_POST['downvote'])) {
    $downquery = mysqli_query($connect,"UPDATE voting_count SET vote_down=vote_down+1 WHERE `question_id` ='$question'");
    header("location: question.php?question=".$question);
}
